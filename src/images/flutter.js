export default function Flutter(){
    return(
    <>
    <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 65 65">
        <g transform="matrix(.061615 0 0 .061615 -1.430818 -1.2754)">
            <defs>
                ...
                <g clip-path="url(#B)"><path d="M360.3 779.7L520 939.5 959.4 500H639.9z" fill="#000"/></g>
                <defs>
                ...
                <path clip-path="url(#D)" d="M639.9 20.7h319.5l-679 679.1L120.6 540z" fill="#000"/>
                <defs>
                ...
                <path clip-path="url(#F)" d="M520 939.5l119.9 119.8h319.5L679.8 779.7z" fill="#000"/>
                <defs>
                ...
                <path clip-path="url(#H)" d="M757 857.4l-77.2-77.7L520 939.5z" fill="#000"/>
                <defs>
                ...
                <path d="M959.4 500L679.8 779.7l279.6 279.7H639.9L360.2 779.7 639.9 500h319.5zM639.9 20.7L120.6 540l159.8 159.8 679-679.1H639.9z" fill="#000"/>
        </g>
    </svg>
    </>
    );
