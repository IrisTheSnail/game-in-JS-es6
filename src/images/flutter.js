    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 65 65">
        <g transform="matrix(.061615 0 0 .061615 -1.430818 -1.2754)">
            <defs>
                ...
                <g clipPath="url(#B)"><path d="M360.3 779.7L520 939.5 959.4 500H639.9z" fill="#000"/></g>
                <defs>
                ...
                <path clipPath="url(#D)" d="M639.9 20.7h319.5l-679 679.1L120.6 540z" fill="#000"/>
                <defs>
                ...
                <path clipPath="url(#F)" d="M520 939.5l119.9 119.8h319.5L679.8 779.7z" fill="#000"/>
                <defs>
                ...
                <path clipPath="url(#H)" d="M757 857.4l-77.2-77.7L520 939.5z" fill="#000"/>
                <defs>
